    ...
    \begin{columns}
        \begin{column}{0.7\textwidth}
            \begin{itemize}
                ...
                \note{Bedenken}
                \note[item]{Angst vor unberechtigter Weitergabe}
                \note[item]{Missbrauch von Daten}
                \note[item]{Kontrollverlust}
...
\begin{frame}{Einleitung II}
    ...
    \begin{figure}
        ...
        \note{
            \begin{itemize}
                \item aktuell findet Entw. wie folgt statt
                \item für einen bestimmten Prozess brauche ich folgende Daten
                \item dafür spezielle Datenspeicher entwerfen und entlang einer Prozesskette integrieren
                \item zwei Endresultate integrieren, bspw. Krankschreibung von Krankenkasse und Arbeitgeber
                \item[$\Rightarrow$] aufwendig! // wo wir hin wollen, sind Daten-getriebene Prozesse
            \end{itemize}
