    ...
    \begin{columns}
        \begin{column}{0.6\textwidth}
            ...
            \begin{itemize}
                ...
                \note{
                    \begin{itemize}
                        \item jemand will Studie mit falschen Daten verfälschen, Medikament was nicht wirkt
                    \end{itemize}
                }
...
\begin{frame}{Aktualität und Verfügbarkeit von Daten}
    ...
    \begin{itemize}
        ...
        \pause
        \note{\begin{itemize}
            \item Verfügbarkeit? $\to$ Interoperabilität, offene Standards
        \end{itemize}}
...
\begin{frame}{Zugänglichkeit}
    \begin{itemize}
        \note{\begin{itemize}
            \item wenn wir Sachen von oben erfüllt haben, dass können wir ... entgegenwirken
        \end{itemize}}
...
\begin{frame}{Wie erreichen wir das?}
    ...
    \note{
        \begin{itemize}
            \item ...
            \item hier setzt Konzept Data Spaces an
            \item ermöglicht multilaterales, sicheres Data Sharing
