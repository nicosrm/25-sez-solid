...
\begin{frame}{Zukunft}
    % TODO: Story bauen
    % ich gehe zu Unternehmen und öffne meine Daten-Tasche dynamisch
    % bringe ganze Daten mit

    \begin{itemize}
        \item Digitalisierung zum Profitieren von Vorteilen
        % TODO: digitales Bild nicht ausreichen, 
...
% TODO: gewünscht: daten-orientiertes Vorgehen statt Proz.-Orientierung
% Daten als Antreiber statt Proz.
