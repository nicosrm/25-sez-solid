        ...
        \begin{column}{0.7\textwidth}
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \item<3-> Angst vor unberechtigter Weitergabe % (Geschäftsgeheimnisse)
                \end{itemize}
    ...
    \begin{columns}
        \begin{column}{0.65\textwidth}
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    % dasselbe in grün, aber es ist nicht dasselbe, sondern etwas veraltetes
        ...
        \begin{column}{0.35\textwidth}
            ...
            \begin{figure}
                ...
                % Bsp: nach Umzug bei jedem Arzt neue Adresse angeben
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
